---
title: "Boundary, Posting, and Staking Surveys in Britannia Beach"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Britannia Beach, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Britannia Beach</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Britannia Beach, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Britannia Beach',
  heroImage: '/images/britannia-beach.webp',
  localAuthorityName: 'Squamish-Lillooet Regional District',
  municipalLink: 'https://www.slrd.bc.ca/planning-development/building-services',
...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Britannia Beach, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
