...
description: "Expert Boundary Surveys services in Pemberton, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary Surveys in <span className=\"text-brand-green font-semibold\">Pemberton</span>",
  description: "Expert Boundary Surveys services in Pemberton, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Pemberton',
  heroImage: '/images/mt-currie.webp',
  localAuthorityName: 'Village of Pemberton',
