---
title: "Boundary, Posting, and Staking Surveys in Bowen Island"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Bowen Island, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Bowen Island</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Bowen Island, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Bowen Island',
  heroImage: '/images/bowen-island.webp',
  localAuthorityName: 'Bowen Island Municipality',
  municipalLink: 'https://www.bowenislandmunicipality.ca/building-permits/',
...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Bowen Island, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
