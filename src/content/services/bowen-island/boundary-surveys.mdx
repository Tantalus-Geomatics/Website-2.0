...
description: "Expert Boundary Surveys services in Bowen Island, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary Surveys in <span className=\"text-brand-green font-semibold\">Bowen Island</span>",
  description: "Expert Boundary Surveys services in Bowen Island, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Bowen Island',
  heroImage: '/images/bowen-island.webp',
  localAuthorityName: 'Bowen Island Municipality',
