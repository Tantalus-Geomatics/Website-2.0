---
title: "Boundary, Posting, and Staking Surveys in Whistler"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Whistler, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Whistler</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Whistler, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Whistler',
  heroImage: '/images/black-tusk.webp',
  localAuthorityName: 'Resort Municipality of Whistler',
  municipalLink: 'https://www.whistler.ca/business/building-development/building-permits/',
...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Whistler, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
