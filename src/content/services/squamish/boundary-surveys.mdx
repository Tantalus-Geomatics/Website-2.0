...
description: "Expert Boundary Surveys services in Squamish, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary Surveys in <span className=\"text-brand-green font-semibold\">Squamish</span>",
  description: "Expert Boundary Surveys services in Squamish, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Squamish',
  heroImage: '/images/tantalus-hero-banner.webp',
  localAuthorityName: 'District of Squamish',
