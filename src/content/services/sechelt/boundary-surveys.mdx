...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Sechelt, BC" width="600" height="400" loading="lazy" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
