...
export const metadata = {
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Sechelt</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Sechelt, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Sechelt',
  heroImage: '/images/sechelt.webp',
  localAuthorityName: 'Municipality of Sechelt',
  municipalLink: 'https://example.com',
