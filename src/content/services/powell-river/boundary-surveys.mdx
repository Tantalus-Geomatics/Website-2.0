---
title: "Boundary, Posting, and Staking Surveys in Powell River"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Powell River, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Powell River</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Powell River, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Powell River',
  heroImage: '/images/power-river.webp',
  localAuthorityName: 'Municipality of Powell River',
  municipalLink: 'https://example.com',
