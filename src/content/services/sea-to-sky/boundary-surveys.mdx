---
title: "Boundary, Posting, and Staking Surveys in Sea To Sky"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Sea To Sky, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Sea To Sky</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Sea To Sky, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Sea To Sky',
  heroImage: '/images/sea-to-sky.webp',
  localAuthorityName: 'Municipality of Sea To Sky',
  municipalLink: 'https://example.com',
  ...
  serviceImages: [
  {
    ...
    "alt": "BC Land Surveyor conducting Boundary Surveys in Sea To Sky, BC",
...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Sea To Sky, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
