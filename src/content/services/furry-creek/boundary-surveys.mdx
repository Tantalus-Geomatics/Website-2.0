...
description: "Expert Boundary Surveys services in Furry Creek, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary Surveys in <span className=\"text-brand-green font-semibold\">Furry Creek</span>",
  description: "Expert Boundary Surveys services in Furry Creek, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Furry Creek',
  heroImage: '/images/furry-creek.webp',
  localAuthorityName: 'Squamish-Lillooet Regional District',
