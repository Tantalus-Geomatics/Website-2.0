---
title: "Boundary, Posting, and Staking Surveys in Furry Creek"
description: "Expert Boundary, Posting, and Staking Surveys in  services in Furry Creek, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">Furry Creek</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in Furry Creek, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Furry Creek',
  heroImage: '/images/furry-creek.webp',
  localAuthorityName: 'Squamish-Lillooet Regional District',
  municipalLink: 'https://www.slrd.bc.ca/planning-development/building-services',
...
<img src="/images/boundary-surveys.webp" alt="BC Land Surveyor performing Boundary Surveys in Furry Creek, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
