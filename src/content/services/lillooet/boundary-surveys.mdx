...
description: "Expert Boundary Surveys services in Lillooet, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  title: "Boundary Surveys in <span className=\"text-brand-green font-semibold\">Lillooet</span>",
  description: "Expert Boundary Surveys services in Lillooet, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'Lillooet',
  heroImage: '/images/seton-lake.webp',
  localAuthorityName: 'District of Lillooet',
