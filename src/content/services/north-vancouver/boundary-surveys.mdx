---
title: "Boundary, Posting, and Staking Surveys in North Vancouver"
description: "Expert Boundary, Posting, and Staking Surveys in  services in North Vancouver, ensuring accurate legal layout and strict municipal zoning compliance."
...
export const metadata = {
  ...
  "url": "https://www.tantalusgeomatics.com/north-vancouver/services/boundary-surveys/",
  ...
  title: "Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\">North Vancouver</span>",
  description: "Expert Boundary, Posting, and Staking Surveys in <span className=\"text-brand-green font-semibold\"></span> services in North Vancouver, ensuring accurate legal layout and strict municipal zoning compliance.",
  locationName: 'North Vancouver',
  heroImage: '/images/north-vancouver.webp',
  localAuthorityName: 'City and District of North Vancouver',
  municipalLink: 'https://www.dnv.org/property-and-development/building-and-permits',
  ...
  serviceImages: [
  {
    ...
    "alt": "BC Land Surveyor conducting Boundary Surveys in North Vancouver, BC",
