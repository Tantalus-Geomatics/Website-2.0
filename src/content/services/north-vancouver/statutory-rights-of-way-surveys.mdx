...
<img src="/images/statutory-rights-of-way-surveys.webp" alt="BC Land Surveyor conducting Statutory Rights of Way Surveys in North Vancouver, BC" className="w-full md:w-1/2 md:float-right mb-6 md:ml-8 md:mb-8 rounded-2xl shadow-lg border border-slate-200 object-cover" />
