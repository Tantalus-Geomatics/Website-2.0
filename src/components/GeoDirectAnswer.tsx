...
const questionBase: Record<Align, string> = {
  center:
    'text-xl sm:text-2xl font-light text-slate-900 mb-4 leading-snug text-center max-w-4xl mx-auto',
  left: 'text-xl sm:text-2xl font-light text-slate-900 mb-4 leading-snug max-w-4xl',
};
