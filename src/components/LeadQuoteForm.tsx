...
const embeddedInput =
  'w-full px-4 py-3 bg-brand-dark border border-white/20 text-white placeholder-white/40 focus:border-brand-green outline-none transition-all font-light rounded-xl';
...
function SubmitButton({
  ...
  return (
    <button
      ...
      className="w-full py-3 bg-brand-green hover:bg-brand-green-light text-black font-semibold transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed rounded-full"
    >
          ...
          <textarea
            ...
            className={
              isContact
                ...
                : 'w-full px-4 py-3 bg-brand-dark border border-white/20 text-white placeholder-white/40 focus:border-brand-green outline-none transition-all font-light resize-none rounded-xl'
            }
