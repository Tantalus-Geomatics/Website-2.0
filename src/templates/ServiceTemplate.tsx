...
const LeadQuoteForm = lazy(() => import('../components/LeadQuoteForm'));
    ...
    <PageShell>
      ...
      <section className="py-16 md:py-24 bg-white border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Suspense fallback={<div className="animate-pulse text-brand-green text-center py-4">Loading FAQs...</div>}>
            <FAQAccordion faqs={faqs} locationName={locationName || 'the Sea to Sky'} />
          </Suspense>
        </div>
      </section>
      ...
      <section id="quote-form" className="py-16 md:py-24 bg-stone-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-brand-dark p-8 md:p-10 border border-white/10 shadow-2xl rounded-2xl">
            <Suspense fallback={<div className="animate-pulse text-brand-green text-center py-8">Loading Form...</div>}>
              <LeadQuoteForm
                variant={formVariant}
