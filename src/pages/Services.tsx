...
export default function Services() {
  ...
  return (
    <div className="bg-brand-black min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-brand-dark py-32 text-center border-b border-white/10 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6 tracking-tight">Professional Geomatics Services</h1>
