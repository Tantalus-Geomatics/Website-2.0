  ...
  return (
    <PageShell>
      <SEO 
        ...
        description="Get expert answers to common BC land surveying questions — from property staking and topographic surveys to strata plans and subdivision requirements in the Sea to Sky."
