...
const problems = [
  {
    ...
    description: 'A survey provides a clear depiction of problems related to buildings or improvements extending over property lines or not conforming to municipal zoning setback requirements, which can create significant liabilties for purchasers and lenders if not identified prior to the transaction.',
  },
  {
    problem: 'Incomplete Coverage and Hidden Costs',
    description: 'Title insurance requires separate policies to protect the owner and the lender. Often, it only protects the amount of the mortgage, leaving the cost of resolving other problems to the new owner.',
  },
  {
            ...
            {[
              {
                ...
                body: "Building location certificates are based on an actual site inspection and measurements by qualified personnel. It provides a certified drawing of your property including all buildings, constructed improvements, easements, convenants, right of ways and other interest in relation to property boundaries.",
                icon: MapPinned,
              },
              {
                step: '2',
              ...
              },
              {
                ...
                body: 'They retain a lasting usefulness to the property owner as both a record of the state of the property and as a planning tool for proposed construction, land use and lot subdivision.',
                icon: ClipboardList,
              },
